...
namespace son_calisma_merchantapp.Entities;
...
public sealed class Merchantdetails
{
    ...
    public string ApplicationStatus { get; set; } = MerchantApplicationStatuses.Pending;
    public DateTime CreatedAt { get; set; } = DateTime.UtcNow;
    public DateTime? UpdatedAt { get; set; }
    public ICollection<MerchantApplicationHistory> Histories { get; set; } = [];
    public ICollection<MerchantDocument> Documents { get; set; } = [];
}
